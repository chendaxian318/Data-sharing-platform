...
void _help()        // 显示帮助文档。
{
    ...
    //          "<username>chendaxian</username><password>cx202318.</password>"\
    ...
    printf("Sample:/project/tools/bin/procctl 30 /project/tools/bin/ftpgetfiles /log/idc/ftpgetfiles_test.log " \
              "\"<host>192.168.88.130:21</host><mode>1</mode>"\
              "<username>chendaxian</username><password>cx202318.</password>"\
    ...
    printf("<host>192.168.88.130:21</host> 远程服务端的IP和端口。\n");
    printf("<mode>1</mode> 传输模式，1-被动模式，2-主动模式，缺省采用被动模式。\n");
    printf("<username>chendaxian</username> 远程服务端ftp的用户名。\n");
    printf("<password>cx202318.</password> 远程服务端ftp的密码。\n");
