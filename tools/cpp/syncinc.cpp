...
void _help(char *argv[])
{
    ...
    printf("把T_ZHOBTMIND1表中全部的记录增量同步到T_ZHOBTMIND2中。\n");
    printf("Sample:/project/tools/bin/procctl 10 /project/tools/bin/syncinc /log/idc/syncinc_ZHOBTMIND2.log "\
              "\"<localconnstr>idc/idcpwd</localconnstr><remoteconnstr>idc/idcpwd</remoteconnstr>"\
              "<charset>Simplified Chinese_China.AL32UTF8</charset>"\
              "<remotetname>T_ZHOBTMIND1</remotetname><lnktname>T_ZHOBTMIND1</lnktname>"\
    ...
    printf("把T_ZHOBTMIND1表中满足\"and obtid like '57%%'\"的记录增量同步到T_ZHOBTMIND3中。\n");
...
bool _syncinc(bool &bcontinue)
{
    ...
    //                   select obtid,ddatetime,t,p,u,wd,wf,r,vis,upttime,keyid from T_ZHOBTMIND1
